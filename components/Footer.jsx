...
const Footer = () => {
    return (
        <div className="bg-coffee text-white relative text-center p-12 flex align-center justify-center">
            <div className="absolute -top-6 w-14 h-14 text-lg border-none bg-coffeeLight2 transition-all duration-200 ease-in-out rounded-full text-white">
                <a href="#" className="flex justify-center items-center text-center w-full h-full">
